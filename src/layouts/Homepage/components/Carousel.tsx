...
export const Carousel = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      //make connection and verify
      const baseUrl: string = `https://localhost:8443/api`;
      ...
      //get data response, convert to json, get data out of json and loop into loadedBooks
  ...
  // empty array to signify that the function doesn't reload whenever anything in the array changes so empty array means nothing to reload the api
